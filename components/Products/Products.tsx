      ...
      <div className="flex flex-col sm:flex-row gap-4 w-full md:w-auto">
        <form className="w-full sm:w-auto">
          <select
            ...
            className="block w-full sm:w-auto px-4 py-3 text-base text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
          >
